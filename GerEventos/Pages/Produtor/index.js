$(function () {
    ...
    var createModal = new abp.ModalManager(abp.appPath + 'Produtor/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Produtor/EditModal');

    // Initialize DataTable
    var dataTable = $('#ProdutorTable').DataTable(
