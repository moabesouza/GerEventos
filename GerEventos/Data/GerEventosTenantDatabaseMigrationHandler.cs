...
public class GerEventosTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<GerEventosTenantDatabaseMigrationHandler> _logger;

    public GerEventosTenantDatabaseMigrationHandler(
        GerEventosDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<GerEventosTenantDatabaseMigrationHandler> logger)
    {
